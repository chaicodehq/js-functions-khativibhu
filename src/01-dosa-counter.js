...
export function calculateDosaOrder(type, quantity = 1, isSpicy = false) {
  if(typeof type !== 'string' || (type !=='plain' && type !=='masala' && type !=='onion' && type !=='butter' && type !=='paper' && type !=='cheese')  || typeof quantity !== 'number' || isNaN(quantity) || quantity<=0)
  {
    return null;
  }
